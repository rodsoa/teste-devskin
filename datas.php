...
/**
 * Não encontrei com um forma eficaz de realizar o teste sem utilizar das funçoes
 * nativas. Para não deixar parado, utilizei um helper que tenho comigo quando preciso fazer essas comparações
 * e não tenho como utilizar um Carbon ou mesmo a Classe DateTime.
 */
function diferencaEmDias (string $data1, string $data2): int {
    return round(abs(strtotime($data1) - strtotime($data2))/86400);
}
